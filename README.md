...
## 版本
- **V_0624** — 2026-06-20 自動補血（HP 低於門檻自動買最大治療藥水）
- **V_0623** — 2026-06-20 頁面標題與 H1 顯示動態版次
- **V_0622** — 2026-06-20 怪物圖片下方加血條（綠/橘/紅三段 + 25% 以下脈動）
- **V_0621** — 2026-06-20 補血藥劑系統 + 區域解鎖改為方案 B ×20（100/200/300/400/500）
- **V_0620** — 2026-06-20 技能樹完整實作（speed_mult → 命中/閃避、新增命中機制、技能效果計算器）
- **V_0613** — 2026-06-20 閃避 + 暴擊
- **V_0612** — 2026-06-20 即時戰鬥（每秒一回合）
